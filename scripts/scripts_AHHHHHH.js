...
<div id="start" class="container" ng-controller="CustomExamStartCtrl">\n
    ...
    <div id="start" class="container">\n
        ...
        <div class="row text-center">\n
            ...
            <div class="col-md-3"></div>\n </div>\n</div>'), a.put("views/three-hours-exam-start.html", '
    <div id="start" class="container" ng-controller="ThreeHoursExamStartCtrl">\n
        <div class="row">\n
            ...
            <div class="col-sm-2 col-md-4 text-center">\n
                <div class="row">\n
                    <div class="btn-group" role="group">\n <button id="stopButton" type="button" ng-confirm-click="Are you sure you want to stop the clock?" ng-confirm-on="stopOn" ng-click="stopTimer()" class="btn btn-default">{{stopLabel}}</button>\n <a href="#/three-hours-exam" ng-confirm-click="Are you sure you want to reset the exam clock?"
                            ng-confirm-on="true" ng-click="resetTimer()" class="btn btn-danger">Reset</a>\n </div>\n </div>\n </div>\n
            <div class="col-sm-3 col-md-3">\n <img src="images/UoA_Logo_2015.png" class="img-responsive">\n </div>\n </div>\n\n
        <div class="row text-center">\n
            <editable-title exam-title="examTitle"></editable-title>\n </div>\n\n
        ...
        <div class="row" ng-hide="finished || showGoodLuck">\n
            ...
            <div class="col-sm-8 col-md-8 text-center">\n
                ...
                <div class="row text-right">\n
                    <h3>READING TIME STARTS AT: {{times.readingStartTime | date: \'HH:mm:ss\'}}</h3>\n
                    <h3 ng-if="showWritingStartTime">WRITING TIME STARTS AT: {{writingStartTime() | date: \'HH:mm:ss\'}}</h3>\n </div>\n </div>\n </div>\n</div>'), a.put("views/three-hours-exam.html", '
    <div id="start" class="container">\n
        <!-- AngularJS does not like short tags -->\n
        <exam-clock-header></exam-clock-header>\n\n
        <div class="row text-center">\n
        ...
        <div class="row">\n
            ...
            <div class="col-md-7 text-center">\n
                ...
                <h3>Press start at the commencement of Reading Time</h3>\n </div>\n </div>\n</div>'), a.put("views/two-hours-exam-start.html", '
    <div id="start" class="container" ng-controller="TwoHoursExamStartCtrl">\n
        <div class="row">\n
            ...
            <div class="col-sm-2 col-md-4 text-center">\n
                <div class="row">\n
                    <div class="btn-group" role="group">\n <button id="stopButton" type="button" ng-confirm-click="Are you sure you want to stop the clock?" ng-confirm-on="stopOn" ng-click="stopTimer()" class="btn btn-default">{{stopLabel}}</button>\n <a href="#/two-hours-exam" ng-confirm-click="Are you sure you want to reset the exam clock?"
                            ng-confirm-on="true" ng-click="resetTimer()" class="btn btn-danger">Reset</a>\n </div>\n </div>\n </div>\n
            <div class="col-sm-3 col-md-3">\n <img src="images/UoA_Logo_2015.png" class="img-responsive">\n </div>\n </div>\n\n
        <div class="row text-center">\n
            <editable-title exam-title="examTitle"></editable-title>\n </div>\n\n
        ...
        <div class="row" ng-hide="finished || showGoodLuck">\n
            ...
            <div class="col-sm-8 col-md-8 text-center">\n
                ...
                <div class="row text-right">\n
                    <h3>READING TIME STARTS AT: {{times.readingStartTime | date: \'HH:mm:ss\'}}</h3>\n
                    <h3 ng-if="showWritingStartTime">WRITING TIME STARTS AT: {{writingStartTime() | date: \'HH:mm:ss\'}}</h3>\n </div>\n </div>\n </div>\n</div>'), a.put("views/two-hours-exam.html", '
    <div id="start" class="container">\n
        <!-- AngularJS does not like short tags -->\n
        <exam-clock-header></exam-clock-header>\n\n
        <div class="row text-center">\n
